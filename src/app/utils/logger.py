...
def get_logger(
    ...
    Args:
        ...
        streaming_log_level (int, optional): Log level for console logging. Defaults to app.env.STREAMING_LOG_LEVEL.
        file_log_level (int, optional): Log level for file logging. Defaults to app.env.FILE_LOG_LEVEL.
        log_filepath (Optional[str], optional): Path to the log file. Defaults to app.env.LOG_FILEPATH.
